...
<section style="margin-top: 150px; margin-bottom: 40px;">
  <jsp:include page="tag.jsp"></jsp:include>
	...
	<nav style="position: fixed; top: 80px; height: 50px; line-height: 50px; width: 100%; background: #425e8e;">
		<% 
	if(d == null){	//로그인 안했을 때
		//실행할 코드
		//천국
		...
		<table>
			...
			<tr>
				<td style="display: flex; justify-content: center;">
					<input type="button" class="btn first" value="예매" onclick="yeahmae()"/>
				</td>
			</tr>
		</table>
	</form>
